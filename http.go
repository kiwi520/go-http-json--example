...
func httptc() {
	...
	fmt.Printf("%+v\n",myInfo)
    // fmt.Println((*string)(unsafe.Pointer(uintptr(myInfo))
 //    fmt.Printf("%+v\n", myInfo.State)
	// fmt.Printf("%+v\n", myInfo.Models[0].Gid)
...
func main() {
	...
	// http.HandleFunc("/wifi", httpDo)         //设置访问的路由
	// http.HandleFunc("/tc", httptc)         //设置访问的路由
...
// var data  map[string]interface{} = json.Unmarshal(JsonStr, &myInfo)
// if errs != nil {
